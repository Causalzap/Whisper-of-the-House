...
export const guideClusters: GuideCluster[] = [
  ...
  eyebrow: "Guide Hub",
  hubStatus:
    "30 Campaign levels + solver + module guides + roles + Chaos + 23 achievements",

  description:
    "Diagnose what is ending a BOMBANANA run, route a known problem to the right module guide or solver, improve Blind / Deaf / Mute teamwork, follow all 30 Campaign levels, manage Chaos, and finish all 23 achievements.",

  coverage: [
    "Run diagnosis across rule mistakes, bad live state, relay failures, and attention problems, with direct routing to the guide that matches the actual bottleneck",
    "Full 30-level Campaign progression with timers, fixed and random module slots, mistake allowances, Chaos combinations, module introduction points, readiness checks, and replay decisions",
    "Live Module Solver for Cable / Wire, Direction, and Calculator when the current panel is known and the state is trustworthy",
    "Dedicated module help for Cable / Wire, Direction, Calculator, Symbol, Piano, Soundboard, Switch, and Morse, with each guide owning its full rules, examples, recovery cases, and execution decisions",
    "Blind, Deaf, and Mute teamwork through physical-position language, perspective, repeat and reset conventions, ordered information, role fit, and role swapping",
    "Chaos management across Slider, Pressure, and Alarm, including interruption priority, preserving unfinished progress, and returning to the correct defusal state",
    "First-pass help for Color Slider, Maze, and Monkey-Says, plus Campaign, Endless, Custom, purchase-fit, and Keep Talking and Nobody Explodes comparisons",
    "All 23 Steam achievements with a persistent checklist and cleanup route for Campaign milestones, repeat counters, slaps, repairs, baskets, Custom, and Endless",
  ],
  ...
  pages: [
    {
      ...
      type: "Guide Hub",
      description:
        "Start with what actually broke in the run, then move to the solver, module guide, role fix, Chaos response, Campaign checkpoint, mode, or completion route that fits the problem.",
      image:
        "/images/bombanana/bombanana-hub.webp",
      imageFit: "cover",
      imagePosition: "center",
      ...
      home: {
        spotlightMeta:
          "Run diagnosis, 30 Campaign levels, Module Solver, Blind / Deaf / Mute roles, Cable, Direction, Calculator, Symbol, Piano, Soundboard, Switch, Morse, Chaos, Maze, Monkey-Says, Endless, Custom, and 23 achievements",
      },
...

    {
      ...
      type: "Puzzle Help",
      description:
        "Enter a reliable current Cable / Wire, Direction, or Calculator state and get the next physical input without carrying an old answer into a changed panel.",
      date: "Updated recently",
      image:
      ...
      home: {
        ...
        spotlightOrder: 1,
        spotlightMeta:
          "Cable / Wire state, Direction LED + Braille, Calculator arithmetic, odd / even parity, final keypad digit, stale-state checks, and next physical action",
      },
...

    {
      ...
      type: "Walkthrough",
      description:
        "Map all 30 Campaign levels by timer, module mix and Chaos load, then use each progression break to decide whether the team is ready to advance or should replay.",
      date: "Updated recently",
      image:
      ...
      home: {
        ...
        spotlightOrder: 2,
        spotlightMeta:
          "All 30 levels, timers, mistake allowance, Random Easy / Medium / Hard slots, Switch at 16, Maze at 18, Morse at 21, Monkey-Says at 23, late-game Chaos, and replay checkpoints",
      },
...

    {
      ...
      type: "Puzzle Help",
      description:
        "Turn cable count, the active LED, and wire colors into one physical cut position that Blind can execute without another translation step.",
      date: "Updated recently",
      image:
...

    {
      ...
      type: "Puzzle Help",
      description:
        "Finish the arithmetic stage first, reread the changed LED, combine that color with odd or even parity, and press the correct final Calculator key.",
      date: "Updated recently",
      image:
...

    {
      ...
      type: "Guide",
      description:
        "Build a reliable Blind, Deaf, and Mute information path with physical positions, perspective rules, repeat and reset signals, confirmations, and better role assignments.",
      date: "Updated recently",
      image:
...

    {
      ...
      type: "Puzzle Help",
      description:
        "Pair the current LED with the Braille number, resolve the matching direction across all 36 states, and avoid stale reads or left/right perspective errors.",
      date: "Updated recently",
      image:
      ...
      home: {
        ...
        spotlightOrder: 3,
        spotlightMeta:
          "Braille 1–9, all 36 LED-number states, Green + 2 examples, current-state rereads, physical direction input, and perspective errors",
      },
...

    {
      ...
      type: "Puzzle Help",
      description:
        "Find the symbol that makes the sound, describe that shape consistently, follow the current stage, and press the correct colored button.",
      date: "Updated recently",
      image:
      ...
      home: {
        ...
        spotlightOrder: 4,
        spotlightMeta:
          "Sounding symbol, pointer rotation, four stages, stable shape names, look-alike symbols, current-stage color input, and Level 8",
      },
...

    {
      ...
      type: "Puzzle Help",
      description:
        "Combine the Braille octave with the active light, find the matching four-note sequence, keep its order intact, and recover cleanly from a bad Piano input.",
      date: "Updated recently",
      image:
      ...
      home: {
        ...
        spotlightOrder: 5,
        spotlightMeta:
          "Braille octave, Red / Yellow / Green / Blue light, four-note sequences, Yellow + 1 example, sequence retention, input mistakes, and Level 9",
      },
...

    {
      ...
      type: "Puzzle Help",
      description:
        "Locate the button that produces sound, combine its Braille value and color, resolve the 3×3 answer pattern, and keep track of cells already pressed.",
      date: "Updated recently",
      image:
      ...
      home: {
        ...
        spotlightOrder: 6,
        spotlightMeta:
          "Sound search, Braille + color state, 3×3 grid, target versus answer cells, pressed-cell tracking, recovery from a bad sequence, and Level 11",
      },
...

    {
      ...
      type: "Systems",
      description:
        "Keep Slider, Pressure, and Alarm under control while defusal modules remain active, judge when danger deserves an interruption, and resume from a trustworthy state.",
      date: "Updated recently",
      image:
      ...
      home: {
        ...
        spotlightOrder: 7,
        spotlightMeta:
          "Slider, Pressure, Alarm, interruption timing, unfinished-state recovery, one-player responses, stacked Chaos, and late-Campaign pressure",
      },
    ...
    {
      title:
        "BOMBANANA Switch Guide: 4 Lights, 4 Numbers & Enter",
      href: "/bombanana/switch",
      type: "Puzzle Help",
      description:
        "Read all four light colors and four numbers in position, resolve each Up or Down state, correct uncertain values, and press Enter only after the board agrees.",
      date: "Updated recently",
      image:
      ...
      home: {
        ...
        spotlightOrder: 8,
        spotlightMeta:
          "Four lights, four numbers, Up / Down decisions, positional state, real Switch failures, full confirmation before Enter, and Level 16",
      },
    ...
    {
      title:
        "BOMBANANA Morse Code Guide: 4 Displays, Digits & Enter",
      href: "/bombanana/morse",
      type: "Puzzle Help",
      description:
        "Identify the active Morse position, hear all five signals, convert the pattern to a digit, preserve all four slots, and wait for a clean reread instead of guessing.",
      date: "Updated recently",
      image:
        "/images/bombanana/bombanana-morse-four-displays.webp",
      imageFit: "cover",
      imagePosition: "center",
      imagePadding: false,
      ...
      home: {
        ...
        spotlightOrder: 9,
        spotlightMeta:
          "Four Morse positions, five-signal digits 0–9, active-slot identification, fifth-signal ambiguity, rereads, position recovery, 8145 run, and Enter",
      },
...

    {
      ...
      type: "Achievements",
      description:
        "Track all 23 Steam achievements with a persistent checklist and cleanup route covering Campaign milestones, repeat counters, slaps, repairs, baskets, Custom, and Endless.",
      date: "Updated recently",
      image:
