...
export const metadata: Metadata = {
  title: `Routine Guide: Chapter 05 Endure Stealth Walkthrough`,
  description: `Master the final security protocols in Routine Chapter 5. Find the EL9 Disinfectant formula, drain the Overflow, and reach Security Level 3 clearance.`,
  alternates: {
    canonical: `https://www.whisperofthehouse.com/routine-guide/chapter-5-endure-stealth-walkthrough`,
  }
};

export default function Chapter5Page() {
  // 定义当前页面的唯一 ID，用于从 Content.ts 取值
  const currentSlug = "chapter-5-endure-stealth-walkthrough";
