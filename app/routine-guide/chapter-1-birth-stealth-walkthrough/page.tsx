...
export const metadata: Metadata = {
  title: `Routine Guide: Chapter 01 Birth Stealth Walkthrough`,
  description: `Master the first steps in Routine Chapter 1: Birth. Learn how to obtain the C.A.T tool, navigate The Mall, and solve the Galaxy Video bypass puzzle safely.`, 
  alternates: {
    canonical: `https://www.whisperofthehouse.com/routine-guide/chapter-1-birth-stealth-walkthrough`,
  }
};

export default function Chapter1Page() {
  // 定义当前页面的唯一 ID，用于从 Content.ts 取值
  const currentSlug = "chapter-1-birth-stealth-walkthrough";
