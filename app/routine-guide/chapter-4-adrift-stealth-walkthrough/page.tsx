...
export const metadata: Metadata = {
  title: `Routine Guide: Chapter 04 Adrift Stealth Walkthrough`,
  description: `Master the complex puzzles of Routine Chapter 4: Adrift. Learn how to evade the invisible Entity-A, upgrade your Interface Module, and crack the Vestibule keypad code.`,
  alternates: {
    canonical: `https://www.whisperofthehouse.com/routine-guide/chapter-4-adrift-stealth-walkthrough`,
  }
};

export default function Chapter4Page() {
  // 定义当前页面的唯一 ID，用于从 Content.ts 取值
  const currentSlug = "chapter-4-adrift-stealth-walkthrough";
