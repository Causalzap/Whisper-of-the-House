...
export const metadata: Metadata = {
  title: `Routine Guide: Chapter 06 Finality & Ending Walkthrough`,
  description: `The final chapter of Routine. Learn how to align Prongs 01 & 02, escape Entity-A in the final sprint, and reach the game's mysterious ending in The Canal.`,
  alternates: {
    canonical: `https://www.whisperofthehouse.com/routine-guide/chapter-6-legacy-stealth-walkthrough`,
  }
};

export default function Chapter5Page() {
  // 定义当前页面的唯一 ID，用于从 Content.ts 取值
  const currentSlug = "chapter-6-legacy-stealth-walkthrough";
