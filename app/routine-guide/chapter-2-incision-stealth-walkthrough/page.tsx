...
export const metadata: Metadata = {
  title: `Routine Guide: Chapter 02 Incision Stealth Walkthrough`,
  description: `Master the Living Quarters in Routine Chapter 2. Find the ASN Access ID, solve the surveillance note puzzle, and navigate the fire protocol safely.`,
  alternates: {
    canonical: `https://www.whisperofthehouse.com/routine-guide/chapter-2-incision-stealth-walkthrough`,
  }
};

export default function Chapter2Page() {
  // 定义当前页面的唯一 ID，用于从 Content.ts 取值
  const currentSlug = "chapter-2-incision-stealth-walkthrough";
