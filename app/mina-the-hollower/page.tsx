...
description:
"Use this Mina the Hollower beginner guide and walkthrough to find where to go first, get the Isle Map, farm Bones, pick weapons and unlock fast travel.",
alternates: {
canonical: pageUrl,
},
openGraph: {
...
description:
"A beginner-friendly Mina the Hollower guide hub covering where to go first, the Isle Map, Bones, weapons, trinkets, fast travel and early route planning.",
url: pageUrl,
...
description:
"Use this beginner guide hub for route order, the Isle Map, Bones, weapons, trinkets, fast travel and early tips.",
images: [imageUrls[0]],
},
};
...
/> <GuideArticlePage
       ...
       description="Start here after reaching Ossex. This guide hub points you to the right walkthroughs for the Isle Map, route order, Bones, weapons, trinkets and fast travel."
     ...
     > <MinaTheHollowerContent /> </GuideArticlePage> </main> <Footer />
</>
);
}
