...
description:
"Learn Scale the Depths progression, best upgrades, fish prep, customers, secrets, bait, legendary fish and 100% cleanup routes.",
alternates: {
canonical: pageUrl,
},
openGraph: {
...
description:
"Start strong in Scale the Depths with the best upgrade order, fish prep tips, customer advice, secrets, bait, legendary fish and area cleanup links.",
url: pageUrl,
...
description:
"Follow the core loop, buy the right upgrades, prep fish better, find secrets and use the right 100% guide when cleanup starts.",
images: [imageUrls[0]],
},
};
...
/> <GuideArticlePage
       ...
       description="Start here if you want the upgrade order, prep tips, customer rules, secret hunting basics and the right 100% guide for each area."
     ...
     > <ScaleTheDepthsContent /> </GuideArticlePage> </main> <Footer />
</>
);
}
