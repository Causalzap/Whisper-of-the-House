...
{
id: "permits-knowledge-analysis",
label: "Permits and analysis",
},
{
id: "noviciate-corporation",
label: "Noviciate and corpo",
},
{
...
title: "SpaceCraft Guide: First 10 Hours, FTL, Permits, Base",
description:
"Follow the SpaceCraft route hub for beginner steps, Scanalyzer Alpha, FTL, resources, permits, Noviciate, ship upgrades, and first base automation.",
alternates: {
canonical: pageUrl,
},
openGraph: {
title:
"SpaceCraft Guide: First 10 Hours, FTL, Resources, Permits, Noviciate and Base Automation",
description:
"Use this SpaceCraft guide hub to find the right early-game route: beginner steps, Scanalyzer Alpha, FTL Engine - Eco, Magnetic Plasma, Mining Bureau resources, ship upgrades, Knowledge permits, Lab analysis, Noviciate, corporation access, and first base automation.",
url: pageUrl,
...
description:
"Find the right SpaceCraft guide for the beginner route, FTL, resources, permits, Noviciate, ship upgrades, or first base automation.",
images: [imageUrls[0]],
},
};
...
{
"@type": "Thing",
name: "SpaceCraft Knowledge permits",
},
{
"@type": "Thing",
...
"@type": "Answer",
text:
"Use the route finder table near the top of this hub. It points you to the next guide based on your current progress.",
},
},
{
"@type": "Question",
...
{
"@type": "Question",
name: "What permit should I buy first in SpaceCraft?",
acceptedAnswer: {
"@type": "Answer",
text:
...
"@type": "Answer",
text:
"Check Knowledge permits, Laboratory analysis, blueprint access, and Science, Technology, or Exploration progression. Some recipes need more than materials.",
},
},
{
"@type": "Question",
...
{
"@type": "Question",
name: "How do I unlock corporation access in SpaceCraft?",
acceptedAnswer: {
"@type": "Answer",
text:
...
/>
    ...
    <GuideArticlePage
      title="SpaceCraft Guide: First 10 Hours, FTL, Permits and Base"
      description="Use this SpaceCraft guide hub to find the right page for the beginner route, FTL unlock, resources, permits, Noviciate, ship upgrades, and first base automation."
