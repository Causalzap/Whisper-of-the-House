...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticUrls: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/tears-of-metal/orders-delivery-guide`, changeFrequency: 'weekly', priority: 0.7, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/tears-of-metal/workers-not-working`, changeFrequency: 'weekly', priority: 0.7, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/tears-of-metal/leveling-reputation-unlocks`, changeFrequency: 'weekly', priority: 0.7, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/tears-of-metal/how-to-make-lsd`, changeFrequency: 'weekly', priority: 0.7, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/tears-of-metal/achievements-guide`, changeFrequency: 'weekly', priority: 0.7, lastModified: new Date() },    // 其它固定页……
