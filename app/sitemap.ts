...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticUrls: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/the-adventures-of-elliot/achievements-guide`, changeFrequency: 'weekly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/the-adventures-of-elliot/beginner-guide`, changeFrequency: 'weekly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/the-adventures-of-elliot/cat-locations`, changeFrequency: 'weekly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/the-adventures-of-elliot/walkthrough`, changeFrequency: 'weekly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/the-adventures-of-elliot/shards-of-life-locations`, changeFrequency: 'weekly', priority: 0.8, lastModified: new Date() },    // 其它固定页……

    { url: `${base}/33-immortals/beginner-progression-guide`, changeFrequency: 'weekly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/33-immortals/weapons-unlock-upgrades-guide`, changeFrequency: 'weekly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/33-immortals/relics-paths-wishing-guide`, changeFrequency: 'weekly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/33-immortals/bosses-guide`, changeFrequency: 'weekly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/33-immortals/achievements-guide`, changeFrequency: 'weekly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
