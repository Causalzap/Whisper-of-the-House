...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticUrls: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/how-many-dudes/goat-boss-guide`, changeFrequency: 'monthly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/how-many-dudes/best-builds`, changeFrequency: 'monthly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/how-many-dudes/round-100-guide`, changeFrequency: 'monthly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/how-many-dudes/relic-combinations`, changeFrequency: 'monthly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/how-many-dudes/tier-2-progression`, changeFrequency: 'monthly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/how-many-dudes/achievements-guide`, changeFrequency: 'monthly', priority: 0.8, lastModified: new Date() },    // 其它固定页……

    { url: `${base}/bills-must-be-paid/100-percent-walkthrough`, changeFrequency: 'monthly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/bills-must-be-paid/achievements-guide`, changeFrequency: 'monthly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/bills-must-be-paid/best-upgrades-skill-tree`, changeFrequency: 'monthly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/bills-must-be-paid/bills-loans-bankruptcy`, changeFrequency: 'monthly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
    { url: `${base}/bills-must-be-paid/prestige-rings-bracelets`, changeFrequency: 'monthly', priority: 0.8, lastModified: new Date() },    // 其它固定页……
